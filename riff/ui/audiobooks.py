"""Audiobooks — LibriVox discover + play (Riff Mobile Library spirit, playable)."""
...
class AudiobooksPage(Gtk.Box):
    ...
    def _show_hub(self) -> None:
        ...
        sub = Gtk.Label(
            label="Free public-domain LibriVox titles — search, open a book, "
                  "play chapters in Riff. Audiobookshelf connects in Settings.")
